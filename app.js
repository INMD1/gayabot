...
client.on('ready', () => {
  ...
  client.on("message", message => {
    if (message.content == "help") {
         ...
         .addField('마법에 소라고동,소라고동님',  `소라고동님이 답변을 해드려요!.`, true)
         .addField('날씨 "지역입력"', `입력한 지역의 날씨를 알려드립니다. ex(날씨 서울)`)
         .addField('배그동접자"', `현재 배그 동접자수를 보여줌니다.`)
         .addField('명령어추가 문의', `이메일:lyw514549@gmail.com \n 디스코드:https://discord.gg/XVWmPcT`, true)
         .addField('오픈소스', `https://github.com/INMD1/discord0/tree/master`, true)
         .setTimestamp()
